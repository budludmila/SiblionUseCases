 ...
 * generated in the client.examp.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _EchoString_QNAME = new QName("http://service.example/", "echoString");
    private final static QName _EchoIntResponse_QNAME = new QName("http://service.example/", "echoIntResponse");
    private final static QName _EchoMyObject_QNAME = new QName("http://service.example/", "echoMyObject");
    private final static QName _EchoMyObjectResponse_QNAME = new QName("http://service.example/", "echoMyObjectResponse");
    private final static QName _EchoStringResponse_QNAME = new QName("http://service.example/", "echoStringResponse");
    private final static QName _EchoInt_QNAME = new QName("http://service.example/", "echoInt");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: client.examp.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example/", name = "echoString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example/", name = "echoIntResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example/", name = "echoMyObject")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example/", name = "echoMyObjectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example/", name = "echoStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.example/", name = "echoInt")
