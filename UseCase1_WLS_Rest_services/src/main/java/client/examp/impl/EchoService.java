 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://service.example/", wsdlLocation = "http://127.0.0.1:8080/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://service.example/", "EchoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/echo?wsdl");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://service.example/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.example/", "EchoPort"), Echo.class, features);
    }
